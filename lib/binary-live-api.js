...
var LiveApi = function () {
    ...
    LiveApi.prototype.retryConnection = function retryConnection() {
        var _this4 = this;

        var attempt = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;

        var maxAttempts = 10;
        var delay = Math.min(1000 * Math.pow(2, attempt), 30000); // Máximo de 30 segundos
        ...
        setTimeout(function () {
            ...
            _this4.connect();
            _this4.retryConnection(attempt + 1); // Próxima tentativa
        }, delay);
    };
